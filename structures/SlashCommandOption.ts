...
export const createSlashCommandOption = <OptionType extends ApplicationCommandOptionStringType | ApplicationCommandOptionType | undefined = "string">(type?: OptionType) => {
