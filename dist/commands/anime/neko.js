...
class Neko extends Command_1.Command {
    constructor(kisaragi) {
        ...
        this.run = (discord, message, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            let title;
            if (args[1] === "gif") {
                image = yield neko.sfw.nekoGif();
                title = "Neko Gif";
            }
            else if (args[1] === "lewd") {
                if (args[2] === "gif") {
                    image = yield neko.nsfw.nekoGif();
                    title = "Lewd Neko Gif";
                }
                else {
                    image = yield neko.nsfw.neko();
                    title = "Lewd Neko";
                }
            }
            else {
                image = yield neko.sfw.neko();
                title = "Neko";
            }
