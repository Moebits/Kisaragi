...
class Kitsune extends Command_1.Command {
    constructor() {
        super({
            aliases: [],
            cooldown: 3
        ...
        this.run = (discord, message, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (args[1] === "lewd") {
                if (args[2] === "ero") {
                    image = yield neko.nsfw.eroKitsune();
                    title = "Lewd Ero Kitsune";
                }
                else {
                    image = yield neko.nsfw.kitsune();
                    title = "Lewd Kitsune";
                }
            }
            else {
                image = yield neko.sfw.foxGirl();
                title = "Kitsune";
            }
