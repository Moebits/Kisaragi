    ...
    public run = async (args: string[]) => {
        ...
        async function welcomePrompt(msg: Message) {
            ...
            if (msg.content.toLowerCase() === "reset") {
                ...
                await sql.updateColumn("welcome leaves", "welcome bg images", ["https://i.imgur.com/WOYlL17.gif"])
                await sql.updateColumn("welcome leaves", "welcome bg text", "Welcome username! There are now count members.")
