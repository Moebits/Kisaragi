    ...
    public run = async (args: string[]) => {
        ...
        async function leavePrompt(msg: Message) {
            ...
            if (msg.content.toLowerCase() === "reset") {
                ...
                await sql.updateColumn("welcome leaves", "leave bg images", ["https://i.imgur.com/3KoLVtn.gif"])
                await sql.updateColumn("welcome leaves", "leave bg text", "username left! There are now count members.")
